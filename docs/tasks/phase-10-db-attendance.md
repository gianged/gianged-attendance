...
- [ ] insert_batch function (with ON CONFLICT)
- [ ] insert_one function
- [ ] get_by_date_range function
- [ ] get_by_device_uid function
- [ ] get_daily_summary function (view query)
- [ ] get_daily_summary_by_department function (view query)
- [ ] get_latest_check_time function
- [ ] get_today_count function
